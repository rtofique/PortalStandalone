...
import rest.IgniteClientManager;
import rest.UninitializedClientException;
import rest.number_records.InvalidNumberRecord;
import rest.number_records.ValidNumberRecord;
...
public class QueryProcessor {
  ...
  private String printAllKeys()
  {
    ...
    catch (UninitializedClientException e) {
      e.printStackTrace();
    }
  ...
  private TreeSet<RateCenter> findIgniteRecord(String formattedQuery)
  {
    ...
    catch(ClientServerError | UninitializedClientException e)
    {
      e.printStackTrace();
      result = null;
    }
