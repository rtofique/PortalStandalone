...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/time-string-adder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/lib/</a> time-string-adder.js
    </h1>
    <div class='clearfix'>
...
33
34
35</td><td class="line-coverage quiet"><span class="cline-any cline-yes">6×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var zeroPad = require('./zero-pad')
